...
public:	
	...
	**/
	...
	UFUNCTION(BlueprintCallable)
		static void ApplyRadiusDamage(ARuntimeDestructibleActor* RuntimeDestructibleActor, float BaseDamage, const FVector& HurtOrigin, float DamageRadius, float ImpulseStrength, bool bFullDamage);
...
private:
	...
	**/
	...
	static void GetChunkConvexHullVertices(FTempChunk& DM_Chunk, nvidia::apex::ExplicitHierarchicalMesh& DM_HierarchicalMesh, int32 ChunkIdx);
	...
	**/
	...
	static UIsleComponent* InitFakeIsleComponent(USceneComponent* InParent, const wchar_t* IsleName);
	...
	static void CreatePhysicsConstraint(AIsleActor* RootIsleActor, AFractureChunkActor* TargetFractureChunkActor);

	static AIsleActor* SpawnIsleActor(ARuntimeDestructibleActor* RuntimeDestructibleActor );
