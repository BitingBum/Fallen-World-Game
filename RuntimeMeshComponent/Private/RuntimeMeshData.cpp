...
//void FRuntimeMeshData::SetCollisionConvexMeshes(const TArray<FKConvexElem>& ConvexMeshes)
//{
//	SCOPE_CYCLE_COUNTER(STAT_RuntimeMesh_ClearAllConvexCollisionSections);
//
//	FRuntimeMeshScopeLock Lock(SyncRoot);
...
int32 FRuntimeMeshData::NumMeshSections()
{
	return MeshSections.Num();
}
...
int32 FRuntimeMeshData::NumMeshCollisionSections()
{
	return MeshCollisionSections.Num();
}

FRuntimeMeshCollisionSection* FRuntimeMeshData::GetMeshCollisionSection(int32 Index)
{
	if (MeshCollisionSections.Contains(Index))
		return MeshCollisionSections.Find(Index);
	return nullptr;
}

TMap<int32, FRuntimeMeshCollisionSection> FRuntimeMeshData::GetMeshCollisionSections()
{
	return MeshCollisionSections;
}
...
int32 FRuntimeMeshData::NumConvexCollisionSections()
{
...
{
	return ConvexCollisionSections;
}
...
//int32 FRuntimeMeshData::NumConvexCollisionShapes()
//{
//	return ConvexCollisionShapes.Num();
//}
//
//FKConvexElem* FRuntimeMeshData::GetConvexCollisionShape(int32 Index)
//{
//	if (ConvexCollisionShapes.Contains(Index))
//		return ConvexCollisionShapes.Find(Index);
//	return nullptr;
//}
//
//TMap<int32, FKConvexElem> FRuntimeMeshData::GetConvexCollisionShapes()
//{
//	return ConvexCollisionShapes;
//}
//
