...
///////////////////////////////////////////////////////
//defined in "RuntimeMeshSlicer.h"
...
{
	/*FKConvexElem SlicedElem;
	if (ConvexSection->ConvexPlanes.Num())
	{
	...
	{
		SlicedElem.VertexData = ConvexSection->VertexBuffer;
		SlicedElem.ElemBox = ConvexSection->BoundingBox;
		return &SlicedElem;
	}*/
	return nullptr;
}

 IS BELOW///////////////////////////////////////////////////////////////////////////////////
	...
	{		
		...
		for (int32 ConvexIndex = 0; ConvexIndex < MapSize; ConvexIndex++)
		{
			...
			{				
				...
				{					
					/*TArray<FVector> OtherSlicedConvexVerts;
					SliceConvexElem(ConvexCollisionSection, SlicePlane.Flip(), OtherSlicedConvexVerts);*/
...
 ORIGINAL////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////NOT WORKING//////////////////////////////////////////////////////////////////////////////////////// 
////////////////////////////////////////////////////////////////////InRuntimeMesh->GetBodySetup() returns 
...
void URuntimeMeshSlicer::SliceRuntimeMesh(URuntimeMesh* InRuntimeMesh, FVector PlanePosition, FVector PlaneNormal, URuntimeMesh* OutOtherHalf, ERuntimeMeshSlicerCapOption CapOption, UMaterialInterface* CapMaterial)
{
	if (InRuntimeMesh)
	{
		...
		//{
		//	//UBodySetup* StaticMeshBS = CreateDefaultSubobject<UBodySetup>("StaticMeshBS");
		//	
		//	//StaticMeshBS->CopyBodyPropertiesFrom(InRuntimeMesh->GetBodySetup());
		//	
		//	UBodySetup* StaticMeshBS = NewObject<UBodySetup>();
		//	OutOtherHalf->SetBasicBodySetupParameters(StaticMeshBS);
		//}
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if (InRuntimeMesh && InRuntimeMesh->GetRuntimeMesh())
	{
		...
		if (bCreateOtherHalf)
		{
			if (OutOtherHalf->GetNumSections() > 0)
			{
				...
				/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				/*OutOtherHalf->SetSimulatePhysics(true);
				OutOtherHalf->SetMobility(EComponentMobility::Movable);*/
				/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			}
			else
			{
