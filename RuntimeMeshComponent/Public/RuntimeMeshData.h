...
class RUNTIMEMESHCOMPONENT_API FRuntimeMeshData : public TSharedFromThis<FRuntimeMeshData, ESPMode::ThreadSafe>
{
	...
	/**FRuntimeMeshCollisionConvexMesh Convex shapes used for simple collision */
	TMap<int32, FRuntimeMeshCollisionConvexMesh> ConvexCollisionSections;

	///////////////////////////////////////////////////////////////////////////////////////////////////////////
	/**FKConvexElem Convex shapes used for simple collision */
...
private:
	...
	friend FArchive& operator <<(FArchive& Ar, FRuntimeMeshData& MeshData)
	{
		...
		//////////////////////////////////////////////////////////////
		//Ar << MeshData.ConvexCollisionShapes;
		//////////////////////////////////////////////////////////////
...
public:
	...
	/*Returns RuntimeMesh's Sections Count*/
	int32 NumMeshSections();

	/*Returns RuntimeMesh's Section At Specified Index*/
	FRuntimeMeshSectionPtr GetMeshSection(int32 Index);

	/*Returns TArray Of RuntimeMesh's Sections*/
	TArray<FRuntimeMeshSectionPtr> GetMeshSections();
	...
	////////////////////////////////////////////MESH COLLISION SECTIONS////////////////////////////////////////////////

	/*Returns RuntimeMesh's Collision Sections Count*/
	int32 NumMeshCollisionSections();

	/*Returns RuntimeMesh's Collision Section At Specified Index*/
	FRuntimeMeshCollisionSection* GetMeshCollisionSection(int32 Index);

	/*Returns TMap Of RuntimeMesh's Collision Sections*/
	TMap<int32, FRuntimeMeshCollisionSection> GetMeshCollisionSections();
	...
	/*Returns RuntimeMesh's Convex Collision Sections Count*/
	int32 NumConvexCollisionSections();
	...
	///*Returns RuntimeMesh's Convex Collision Shapes Count*/
	//int32 NumConvexCollisionShapes();

	///*Returns RuntimeMesh's Convex Collision Shapes At Specified Index*/
	//FKConvexElem* GetConvexCollisionShape(int32 Index);

	///*Returns TMap Of RuntimeMesh's Convex Collision Shapes*/
	//TMap<int32, FKConvexElem> GetConvexCollisionShapes();

	///////////////////////////////////////////CONVEX COLLISION SECTIONS///////////////////////////////////////////////


	static void FacesToBuffers(const TArray<Face>& Faces, TArray<TArray<uint32>>& IndexBuffer, TArray<TMap<uint32, int64>>& NeighboursBuffer);
	static void BuffersToFaces(TArray<Face>& Faces, const TArray<TArray<uint32>>& IndexBuffer, const TArray<TMap<uint32, int64>>& NeighboursBuffer);
